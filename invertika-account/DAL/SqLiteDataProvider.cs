...
using sqlite3_stmt=CSCL.Database.SQLite.Sqlite3.Vdbe;
using System.Data;
...
namespace invertika_account.DAL
{
	public class SqLiteDataProvider : DataProvider
	{
		...
		public override void connect()
		{
			...
			string dbName=Configuration.getValue(CFGPARAM_SQLITE_DB, CFGPARAM_SQLITE_DB_DEF);

			Logger.Add(LogLevel.Information, "Trying to connect with SQLite database file '{0}'", dbName);

			mDb=new SQLite(dbName);
			mDbsqlite3=mDb.InstSQLiteDatabase.DB;
